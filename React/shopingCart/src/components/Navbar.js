import logo from "../redux/Slices/logo.png";
...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-row justify-between items-center h-20 max-w-6xl mx-auto">
      ...
      <div className="flex flex-row items-center gap-x-6 mr-6 font-medium">
        <NavLink to="/">
        ...
        <NavLink to="/cart">
          <div className="relative">
            <FaShoppingCart className="text-2xl hover:stroke-green-600 " />
            {cart.length > 0 && (
